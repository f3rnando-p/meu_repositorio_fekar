...
//calculando tmb A MEDIA ANUAL DA TURMA
...
int main(){
    ...
    float acm = 0;
      ...
      for(cont = 0; cont < 5; cont++){
        printf("Entre com a primeira nota do aluno %d: ", cont);
        scanf("%f", &n1);
        printf("Entre com a segunda nota do aluno %d: ", cont);
        scanf("%f", &n2);
        printf("Entre com a terceira nota do aluno %d: ", cont);
        scanf("%f", &n3);
        printf("Entre com a quarta nota do aluno %d: ", cont);
        scanf("%f", &n4);
